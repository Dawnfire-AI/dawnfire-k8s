...
# through SSO (sso.dawnfire.ai). Existing contexts are left alone. Nothing here is a
# secret, and running it again is harmless.
#
...
echo "  kubectl --context training auth whoami"
